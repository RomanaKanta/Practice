...
extension HorizontalProgressBar {
    ...
    public func animateProgress(duration: CGFloat, progressValue: CGFloat) {
...
//    public func startAnimation(type: String, duration: CGFloat) {
//        if isAnimating {
//            return
//        }
//        switch type {
...
//        configureProgressView()
//        
//        animator = UIView.animate(withDuration: 0.25, delay: 0, options: [.curveEaseInOut, .repeat], animations: {
