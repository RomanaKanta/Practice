...
//  SettingsTask
//
//  Created by Romana on 30/11/22.
//

import UIKit

class NotificationViewController: LoanBaseViewController, UITableViewDelegate, UITableViewDataSource {
...
//        setTableView()
    ...
    func setEmptyView(){
        ...
        label.text = "Your notification panel is empty!!"
